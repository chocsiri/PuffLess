  ...
  <div class="fixed bottom-0 left-0 w-full h-[75px] bg-custom-gray text-white p-2">
    <div class="flex justify-around">
      ...
      <router-link to="/other-pollutants">
        <button class="flex flex-col items-center text-black font-bold mt-2">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" stroke-width="1.5" stroke="currentColor" class="size-7" fill="#0E0069">
            <path d="M288 128c-35.3 0-64 28.7-64 64s28.7 64 64 64s64-28.7 64-64s-28.7-64-64-64zM640 192c0 16.9-13.7 30.8-30.8 30.8H542.7c-17.6 0-30.3-14.3-30.3-30.8c0-16.9 13.7-30.8 30.3-30.8H609.2c17.1 0 30.8 13.7 30.8 30.8zM256 192h80v24h-80v-24zM448 64c0-35.3 28.7-64 64-64h112c35.3 0 64 28.7 64 64v384c0 35.3-28.7 64-64 64H512c-35.3 0-64-28.7-64-64V64zM256 128h80v24h-80v-24zM288 448c35.3 0 64-28.7 64-64s-28.7-64-64-64s-64 28.7-64 64s28.7 64 64 64z"/>
          </svg>
      ...
      <router-link to="/about">
        <button class="flex flex-col items-center text-black font-bold mt-2">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" stroke-width="1.5" stroke="currentColor" class="size-7" fill="#0E0069">
            <path d="M256 0c70.7 0 128 57.3 128 128c0 70.7-57.3 128-128 128S128 198.7 128 128C128 57.3 185.3 0 256 0zM128 320h256c35.3 0 64 28.7 64 64v64H64v-64c0-35.3 28.7-64 64-64z"/>
          </svg>
